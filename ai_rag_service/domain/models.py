...
class SensorData:
    ...
    def __post_init__(self):
        # Keep backward compatibility while supporting wide-table naming.
        if self.temperature is None and self.air_temperature is not None:
            self.temperature = self.air_temperature
        elif self.air_temperature is None and self.temperature is not None:
            self.air_temperature = self.temperature
