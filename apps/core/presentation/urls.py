...
urlpatterns = [
    ...
    # API endpoints — /batch/ MUST be listed before /sensor-data/ to avoid URL shadowing
    path('api/v1/sensor-data/batch/', views.sensor_batch_view, name='sensor_batch'),
    ...
    path('api/v1/chat/fallback/', views.chat_fallback_view, name='chat_fallback'),
