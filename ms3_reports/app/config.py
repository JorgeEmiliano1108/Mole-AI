...
class Settings:
    ...
    S3_ENDPOINT: str = os.getenv("MS3_S3_ENDPOINT", "http://minio:9000")
    S3_ACCESS_KEY: str = os.getenv("MS3_S3_ACCESS_KEY", "minioadmin")
    S3_SECRET_KEY: str = os.getenv("MS3_S3_SECRET_KEY", "minioadmin")
    S3_BUCKET: str = os.getenv("MS3_S3_BUCKET", "reports")
